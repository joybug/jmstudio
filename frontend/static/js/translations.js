const translations = {
            ko: {
                ...
                "create_modal_title_template": "템플릿으로 새 문서 생성",
                "tooltip_template_create": "템플릿으로 새 문서 만들기",
                ...
                // Templates
                "tab_templates": "템플릿",
                "sidebar_title_templates": "문서 템플릿 도우미",
                "template_thesis_filename": "학술논문_템플릿.md",
                "template_report_filename": "보고서_템플릿.md",
                "template_wiki_filename": "지식노트_템플릿.md",
                "template_todo_filename": "할일목록_템플릿.md",
                "template_shopping_filename": "쇼핑목록_템플릿.md",
                "template_bucket_filename": "버킷리스트_템플릿.md",
                "template_travel_filename": "여행계획_템플릿.md",
                "template_timetable_filename": "시간표_템플릿.md",
                "template_memo_filename": "메모장_템플릿.md",
                "template_confirm_title": "템플릿 삽입 방식 선택",
                "template_confirm_desc": "에디터에 기존 작성 중인 내용이 있습니다. 템플릿을 현재 커서 위치에 추가로 삽입하시겠습니까, 아니면 기존 내용을 지우고 전체 덮어쓰시겠습니까?",
                "btn_template_insert": "현재 위치에 삽입",
                "btn_template_overwrite": "전체 덮어쓰기 (기존 내용 삭제)",
                "template_thesis_title": "학술 논문 템플릿",
                "template_thesis_desc": "초록, 서론, 관련 연구, 제안 방법, 실험 및 결론을 포함하는 표준 학위/학술 논문 규격.",
                "template_report_title": "대학교/비즈니스 레포트",
                "template_report_desc": "개요, 본론, 분석, 향후 계획 및 참고문헌으로 구성된 정교한 보고서 구조.",
                "template_wiki_title": "지식 기록 & 위키 노트",
                "template_wiki_desc": "개념 정의, 배경 지식, 핵심 원리, 다이어그램 예시 및 관련 링크 체계적 정리.",
                "template_todo_title": "업무 & 개인 TODO 목록",
                "template_todo_desc": "우선순위별 업무 분류, 마감일, 체크박스를 통한 일일/주간 목표 관리.",
                "template_shopping_title": "스마트 쇼핑 리스트",
                "template_shopping_desc": "식료품, 생필품, 가전 등 카테고리별 예산 및 구매 예정 물품 정리.",
                "template_bucket_title": "라이프 버킷 리스트",
                "template_bucket_desc": "인생에서 꼭 이루고 싶은 꿈과 도전, 여행지 및 달성 일지 기록.",
                "template_travel_title": "상세 여행 일정 플래너",
                "template_travel_desc": "준비물 체크리스트, 일자별 이동 동선, 숙소/맛집 및 경비 예산 일괄 수립.",
                ...
                "placeholder_tags_search": "태그 이름 검색...",
                "tags_no_search_results": "검색 결과와 일치하는 태그가 없습니다.",
                ...
                "btn_add": "추가",
                "diagram_desc_class": "UML 클래스 및 설계도",
                "diagram_desc_flowchart": "알고리즘 및 작업 순서도",
                "diagram_desc_gantt": "일정 로드맵 및 기한 관리",
                "diagram_desc_mindmap": "생각 구조화 / 브레인스토밍",
                "diagram_desc_orgchart": "계층형 트리 / 조직 구조",
                "diagram_desc_pie": "데이터 비율 시각화",
                "diagram_desc_sequence": "객체/서비스간 통신 흐름",
                "diagram_desc_state": "시스템 상태 전이 모델링",
                "diagram_label_class": "클래스도",
                "diagram_label_flowchart": "플로우차트",
                "diagram_label_gantt": "간트 차트",
                "diagram_label_mindmap": "마인드맵",
                "diagram_label_orgchart": "조직도 (UML)",
                "diagram_label_pie": "파이 차트",
                "diagram_label_sequence": "시퀀스도",
                "diagram_label_state": "상태도",
                "lbl_all": "전체",
                "math_label_ac_power": "교류 전력",
                "math_label_amdahl": "Amdahl의 법칙",
                "math_label_ang_freq": "각주파수 (w)",
                "math_label_attack_prob": "공격 성공 확률",
                "math_label_backpropagation": "역전파 (BP)",
                "math_label_binary_search": "이진 탐색",
                "math_label_biot_savart": "비오-사바르",
                "math_label_bitwise_xor": "비트 XOR",
                "math_label_capacitor": "커패시터 충방전",
                "math_label_carrier_eq": "캐리어 평형",
                "math_label_ceil": "천장 함수",
                "math_label_channel_capacity": "채널 용량",
                "math_label_checksum": "체크섬",
                "math_label_conv_integral": "컨볼루션 적분",
                "math_label_convolution_ee": "컨볼루션",
                "math_label_coulomb_ee": "쿨롱의 법칙",
                "math_label_cpu_perf": "CPU 성능 공식",
                "math_label_det": "행렬식 (det)",
                "math_label_dft": "이산 푸리에(DFT)",
                "math_label_diode_eq": "다이오드 식",
                "math_label_dot_prod": "내적 (점곱)",
                "math_label_drift_current": "드리프트 전류",
                "math_label_dropout": "Dropout 확률",
                "math_label_ecc": "ECC 암호",
                "math_label_einstein_rel": "아인슈타인 관계",
                "math_label_euler_identity": "오일러 항등식",
                "math_label_exists": "존재 (exists)",
                "math_label_faraday_ee": "패러데이 법칙",
                "math_label_feedback_ctrl": "피드백 제어",
                "math_label_floor": "바닥 함수",
                "math_label_forall": "모든 (for all)",
                "math_label_fourier_op": "푸리에",
                "math_label_grad_descent_fn": "경사하강법",
                "math_label_hadamard": "하다마르 곱",
                "math_label_hash_collision": "해시 충돌",
                "math_label_iff": "동치 (iff)",
                "math_label_imag_unit": "허수 단위 (j)",
                "math_label_implies": "함의 (implies)",
                "math_label_impulse": "임펄스",
                "math_label_in": "속함",
                "math_label_inductor": "인덕터 전류",
                "math_label_infinity_op": "무한대",
                "math_label_inner_prod": "내적",
                "math_label_integral_sym": "적분 기호",
                "math_label_intersection": "교집합",
                "math_label_inverse": "역행렬",
                "math_label_kcl_ee": "KCL (전류)",
                "math_label_kvl_ee": "KVL (전압)",
                "math_label_land": "논리곱 (and)",
                "math_label_laplace_op": "라플라스",
                "math_label_linear_regression": "선형 회귀",
                "math_label_logistic_regression": "로지스틱 회귀",
                "math_label_lor": "논리합 (or)",
                "math_label_lshift": "L Shift (비트)",
                "math_label_matrix_2x2": "2x2 행렬",
                "math_label_matrix_3x3": "3x3 행렬",
                "math_label_maxwell1": "맥스웰 1 (전기)",
                "math_label_maxwell2": "맥스웰 2 (자기)",
                "math_label_maxwell3": "맥스웰 3 (회전)",
                "math_label_maxwell4": "맥스웰 4 (전류)",
                "math_label_modulo": "모듈로",
                "math_label_mosfet_lin": "MOSFET 선형",
                "math_label_mosfet_sat": "MOSFET 포화",
                "math_label_mse": "손실 함수 (MSE)",
                "math_label_nabla": "나블라(역삼각형)",
                "math_label_nabla_ee": "나블라",
                "math_label_neg": "부정 (not)",
                "math_label_norm": "노름 (Norm)",
                "math_label_notin": "속하지않음",
                "math_label_output_eq": "출력 방정식",
                "math_label_partial_op": "편미분",
                "math_label_password_space": "비밀번호 공간",
                "math_label_perceptron": "퍼셉트론 출력",
                "math_label_phase_angle": "위상각",
                "math_label_pid_ctrl": "PID 제어기",
                "math_label_power_eq": "전력 공식",
                "math_label_poynting": "포인팅 벡터",
                "math_label_rc_time": "RC 시상수",
                "math_label_relu_activation": "ReLU 활성화",
                "math_label_rl_time": "RL 시상수",
                "math_label_rsa": "RSA 암복호화",
                "math_label_rshift": "R Shift (비트)",
                "math_label_sampling": "표본화 정리",
                "math_label_secret_key_entropy": "비밀키 엔트로피",
                "math_label_snr": "신호 대 잡음비",
                "math_label_softmax_fn": "Softmax 함수",
                "math_label_state_eq": "상태 방정식",
                "math_label_steady_state_error": "정상상태 오차",
                "math_label_subset": "부분집합",
                "math_label_sum_cs": "합 (Sum)",
                "math_label_superset": "포함관계",
                "math_label_tensor_prod": "텐서곱",
                "math_label_transfer_fn": "전달 함수",
                "math_label_transpose": "전치행렬",
                "math_label_union": "합집합",
                "math_label_unit_step": "단위 계단",
                "math_label_univ_set": "전체집합",
                "math_label_varnothing": "공집합",
            ...
            en: {
                ...
                "create_modal_title_template": "Create Document from Template",
                "tooltip_template_create": "Create New Document from Template",
                ...
                "sidebar_title_templates": "Document Template Helper",
                "template_thesis_filename": "thesis_template.md",
                "template_report_filename": "report_template.md",
                "template_wiki_filename": "wiki_template.md",
                "template_todo_filename": "todo_template.md",
                "template_shopping_filename": "shopping_template.md",
                "template_bucket_filename": "bucket_list_template.md",
                "template_travel_filename": "travel_plan_template.md",
                "template_timetable_filename": "timetable_template.md",
                "template_memo_filename": "memo_template.md",
                "template_confirm_title": "Choose Template Insertion Mode",
                "template_confirm_desc": "There is existing content in the editor. Would you like to insert the template at the current cursor position, or clear the editor and overwrite it completely?",
                "btn_template_insert": "Insert at Cursor",
                "btn_template_overwrite": "Overwrite Document (Clear Existing)",
                "template_thesis_title": "Academic Thesis Template",
                "template_thesis_desc": "Standard academic thesis format including Abstract, Introduction, Methodology, Experiments, and Conclusion.",
                "template_report_title": "University & Business Report",
                "template_report_desc": "Structured report layout with Executive Summary, Discussion, Analysis, and References.",
                "template_wiki_title": "Knowledge & Wiki Note",
                "template_wiki_desc": "Organize concepts, background knowledge, key principles, and reference links systematically.",
                "template_todo_title": "Task Checklist (TODO)",
                "template_todo_desc": "Manage daily and weekly goals sorted by priority, deadlines, and markdown checkboxes.",
                "template_shopping_title": "Shopping List",
                "template_shopping_desc": "Organize items to buy by category (groceries, home goods, tech) with budget planning.",
                "template_bucket_title": "Life Bucket List",
                "template_bucket_desc": "Write down your lifetime dreams, challenges, travel destinations, and achievement logs.",
                "template_travel_title": "Travel Planner",
                "template_travel_desc": "Establish packing list, day-by-day itinerary, accommodation/dining info, and budget.",
                ...
                "placeholder_tags_search": "Search tag name...",
                "tags_no_search_results": "No tags matching search query.",
                ...
                "diagram_desc_class": "UML class & architecture diagram",
                "diagram_desc_flowchart": "Algorithm & workflow chart",
                "diagram_desc_gantt": "Schedule roadmap & deadlines",
                "diagram_desc_mindmap": "Brainstorming & structuring",
                "diagram_desc_orgchart": "Hierarchical tree / organization structure",
                "diagram_desc_pie": "Data ratio visualization",
                "diagram_desc_sequence": "Communication flow between objects",
                "diagram_desc_state": "System state transition modeling",
                "diagram_label_class": "Class Diagram",
                "diagram_label_flowchart": "Flowchart",
                "diagram_label_gantt": "Gantt Chart",
                "diagram_label_mindmap": "Mindmap",
                "diagram_label_orgchart": "Org Chart (UML)",
                "diagram_label_pie": "Pie Chart",
                "diagram_label_sequence": "Sequence Diagram",
                "diagram_label_state": "State Diagram",
                "lbl_all": "All",
                "math_label_ac_power": "AC Power",
                "math_label_amdahl": "Amdahl's Law",
                "math_label_ang_freq": "Angular Frequency (w)",
                "math_label_attack_prob": "Attack Success Probability",
                "math_label_backpropagation": "Backpropagation (BP)",
                "math_label_binary_search": "Binary Search",
                "math_label_biot_savart": "Biot-Savart Law",
                "math_label_bitwise_xor": "Bitwise XOR",
                "math_label_capacitor": "Capacitor Charge/Discharge",
                "math_label_carrier_eq": "Carrier Equilibrium",
                "math_label_ceil": "Ceiling Function",
                "math_label_channel_capacity": "Channel Capacity",
                "math_label_checksum": "Checksum",
                "math_label_conv_integral": "Convolution Integral",
                "math_label_convolution_ee": "Convolution",
                "math_label_coulomb_ee": "Coulomb's Law",
                "math_label_cpu_perf": "CPU Performance Eq",
                "math_label_det": "Determinant (det)",
                "math_label_dft": "Discrete Fourier (DFT)",
                "math_label_diode_eq": "Diode Equation",
                "math_label_dot_prod": "Inner Product (Dot)",
                "math_label_drift_current": "Drift Current",
                "math_label_dropout": "Dropout Probability",
                "math_label_ecc": "ECC Cryptography",
                "math_label_einstein_rel": "Einstein Relation",
                "math_label_euler_identity": "Euler's Identity",
                "math_label_exists": "Exists",
                "math_label_faraday_ee": "Faraday's Law",
                "math_label_feedback_ctrl": "Feedback Control",
                "math_label_floor": "Floor Function",
                "math_label_forall": "For All",
                "math_label_fourier_op": "Fourier",
                "math_label_grad_descent_fn": "Gradient Descent",
                "math_label_hadamard": "Hadamard Product",
                "math_label_hash_collision": "Hash Collision",
                "math_label_iff": "Equivalent (Iff)",
                "math_label_imag_unit": "Imaginary Unit (j)",
                "math_label_implies": "Implies",
                "math_label_impulse": "Impulse",
                "math_label_in": "Element of",
                "math_label_inductor": "Inductor Current",
                "math_label_infinity_op": "Infinity",
                "math_label_inner_prod": "Inner Product",
                "math_label_integral_sym": "Integral Symbol",
                "math_label_intersection": "Intersection",
                "math_label_inverse": "Inverse Matrix",
                "math_label_kcl_ee": "KCL (Current)",
                "math_label_kvl_ee": "KVL (Voltage)",
                "math_label_land": "Conjunction (And)",
                "math_label_laplace_op": "Laplace",
                "math_label_linear_regression": "Linear Regression",
                "math_label_logistic_regression": "Logistic Regression",
                "math_label_lor": "Disjunction (Or)",
                "math_label_lshift": "Left Shift (Bitwise)",
                "math_label_matrix_2x2": "2x2 Matrix",
                "math_label_matrix_3x3": "3x3 Matrix",
                "math_label_maxwell1": "Maxwell 1 (Electric)",
                "math_label_maxwell2": "Maxwell 2 (Magnetic)",
                "math_label_maxwell3": "Maxwell 3 (Curl E)",
                "math_label_maxwell4": "Maxwell 4 (Curl B)",
                "math_label_modulo": "Modulo",
                "math_label_mosfet_lin": "MOSFET Linear",
                "math_label_mosfet_sat": "MOSFET Saturation",
                "math_label_mse": "Loss Function (MSE)",
                "math_label_nabla": "Nabla",
                "math_label_nabla_ee": "Nabla",
                "math_label_neg": "Negation (Not)",
                "math_label_norm": "Norm",
                "math_label_notin": "Not Element of",
                "math_label_output_eq": "Output Equation",
                "math_label_partial_op": "Partial Derivative",
                "math_label_password_space": "Password Space",
                "math_label_perceptron": "Perceptron Output",
                "math_label_phase_angle": "Phase Angle",
                "math_label_pid_ctrl": "PID Controller",
                "math_label_power_eq": "Power Formulas",
                "math_label_poynting": "Poynting Vector",
                "math_label_rc_time": "RC Time Constant",
                "math_label_relu_activation": "ReLU Activation",
                "math_label_rl_time": "RL Time Constant",
                "math_label_rsa": "RSA Enc/Dec",
                "math_label_rshift": "Right Shift (Bitwise)",
                "math_label_sampling": "Sampling Theorem",
                "math_label_secret_key_entropy": "Secret Key Entropy",
                "math_label_snr": "Signal-to-Noise Ratio (SNR)",
                "math_label_softmax_fn": "Softmax Function",
                "math_label_state_eq": "State Equation",
                "math_label_steady_state_error": "Steady-State Error",
                "math_label_subset": "Subset",
                "math_label_sum_cs": "Sum",
                "math_label_superset": "Subset or Equal",
                "math_label_tensor_prod": "Tensor Product",
                "math_label_transfer_fn": "Transfer Function",
                "math_label_transpose": "Transpose Matrix",
                "math_label_union": "Union",
                "math_label_unit_step": "Unit Step",
                "math_label_univ_set": "Universal Set",
                "math_label_varnothing": "Empty Set",
